...
const NettoyageToiture: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col selection:bg-sky-200 relative pt-10 sm:pt-0">
            ...
            <div className="fixed top-0 left-0 right-0 z-[60] bg-sky-950 text-white overflow-hidden border-b border-white/5 pointer-events-none">
            ...
            <main className="flex-grow">
                ...
                <div className="text-center pb-16 px-6 -mt-8">
                    <Link
                        ...
                        className="inline-flex items-center gap-2 text-sky-700 font-bold hover:text-sky-900 transition-colors underline decoration-sky-200 underline-offset-4"
                    >
                        Lire le guide complet sur la fréquence du nettoyage de toiture →
                    </Link>
                </div>
